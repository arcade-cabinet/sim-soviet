...
import type { SettlementTier, TierDefinition } from '../ai/agents/infrastructure/SettlementSystem';
import { GOROD_MIN_DISTINCT_ROLES, TIER_DEFINITIONS, TIER_ORDER } from '../ai/agents/infrastructure/SettlementSystem';
