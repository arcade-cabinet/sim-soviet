...
export const QUALITY_CONTROL: MinigameDefinition = {
  ...
  description:
    'The latest batch smells like victory. Or possibly turpentine. The distinction is ideological.',
  ...
  choices: [
    {
      ...
      onSuccess: {
        ...
        commendations: 1,
        announcement:
          'Premium vodka produced. Even the inspector smiled. This batch could earn an export license.',
      },
      onFailure: {
        resources: { vodka: -5, money: -10 },
        announcement:
          'Standards were too strict. Most of the batch was rejected. The drain is well-fed.',
      },
    },
    {
      id: 'look_away',
      ...
      onSuccess: {
        ...
        announcement:
          'All bottles shipped. Nobody complained. The hangover statistics remain classified.',
      },
      onFailure: {
        resources: { vodka: 5, population: -1 },
        blackMarks: 1,
        announcement:
          'One citizen was hospitalized. The vodka is now evidence. The health inspector has questions.',
        severity: 'warning',
      },
    },
    {
      ...
      onSuccess: {
        ...
        blat: 2,
        announcement:
          'Testing complete. The vodka is excellent. You are certain of this, though the room is spinning.',
      },
      onFailure: {
        resources: { vodka: -3 },
        announcement:
          'Testing went too far. Three hours lost. The lab notes are illegible. The floor is sticky.',
        severity: 'warning',
      },
    },
  ],
  autoResolve: {
    resources: { vodka: -10 },
    announcement:
      'Nobody inspected the batch. It was shipped. The complaints arrived before the bottles did.',
    severity: 'warning',
  },
};
