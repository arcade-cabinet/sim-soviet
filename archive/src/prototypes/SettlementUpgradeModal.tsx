...
type SettlementTier = 'selo' | 'posyolok' | 'pgt' | 'gorod';
...
interface SettlementUpgradeProps {
  onClose?: () => void;
  fromTier?: SettlementTier;
  toTier?: Exclude<SettlementTier, 'selo'>;
...
const TIERS: Record<SettlementTier, TierInfo> = {
  ...
  gorod: {
    ...
    russian: '\u0433\u043E\u0440\u043E\u0434',
    icon: '\uD83C\uDF06',
    title: 'Pervyy Sekretar',
  },
};

const UNLOCK_DATA: Record<Exclude<SettlementTier, 'selo'>, string[]> = {
  posyolok: [
...
const COMMENDATIONS: Record<Exclude<SettlementTier, 'selo'>, string> = {
...
const UnlockList: React.FC<{ items: string[] }> = ({ items }) => (
  <motion.div
...
export const SettlementUpgradeModal: React.FC<SettlementUpgradeProps> = ({
  onClose,
  fromTier = 'selo',
  toTier = 'posyolok',
  settlementName = 'Novaya Zemlya',
  playerName = 'Comrade Petrov',
}) => {
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-6 overflow-y-auto">
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto">
                <div className="relative bg-[#f4e8d0] border-x-0 sm:border-x-0 mx-0">
                  {/* Paper texture */}
                  <div
                  ...
                  {/* Approved stamp — inside parchment area */}
                  <ApprovedStamp />
                </div>
              </div>
              ...
              <div className="bg-[#1a1a1a] border-t-2 border-[#8b0000] px-4 py-4 sm:py-5">
                <motion.button
                  ...
                  className={cn(
                    ...
                    'bg-[#8b0000] hover:bg-[#a00000] active:bg-[#700000]',
                    'text-white text-sm sm:text-base font-bold uppercase tracking-widest',
