...
describe('storageSystem', () => {
  ...
  describe('cold storage spoilage reduction', () => {
    /**
     * Helper: creates a cold-storage building entity directly (bypassing
     * createBuilding which requires a registered def). The cold-storage
     * building type is referenced by storageSystem but not yet in
     * buildingDefs.generated.json.
     */
